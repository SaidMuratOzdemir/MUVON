    ...
    <div className="p-6 space-y-6">
      ...
      {loading ? (
        ...
        <div className="rounded-lg border border-border overflow-hidden">
          {/* Table header */}
          <div className="grid grid-cols-[1fr_auto_auto_auto_auto_auto_auto] gap-x-4 px-4 py-2 bg-muted/20 border-b border-border text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">
            <span>Path</span>
            <span>Host</span>
            <span>Type</span>
          ...
          <div className="divide-y divide-border">
            {filtered.map(route => (
              <div
                key={route.id}
                className="grid grid-cols-[1fr_auto_auto_auto_auto_auto_auto] gap-x-4 items-center px-4 py-2.5 hover:bg-muted/10 transition-colors"
              >
